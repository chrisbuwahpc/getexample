...
!     called within offloaded code. It returns a -1 when the Host CPU.
!
!.............................................................................
    ...
    do offload_case = 1, NUM_CASES
       ...
       do target_id = 0, (max_devices - 1)
          ...
          CASE (1)
             ...
             !DIR$ OMP OFFLOAD target(mic: target_id) if(num_devices > 0)   &
...
#                endif
          ...
          CASE (2)
             ...
             !DIR$ OFFLOAD target(mic: target_id) if(num_devices > 0)       &
                               inout(actual_device_ID)                      &
                               in(offload_section_id) inout(offload_sections)
          ...
          CASE (3)
             ...
             !DIR$ OFFLOAD BEGIN target(mic: target_id) if(num_devices > 0) &
                               inout(actual_device_ID)                      &
                               in(offload_section_id) inout(offload_sections)
