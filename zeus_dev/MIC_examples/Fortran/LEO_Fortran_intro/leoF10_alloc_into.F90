...
!.............................................................................
    ...
    CASE(2)
       ...
       !  Separate offload sections are used also exploit data persistence.
...
#         endif
          ...
          do j = 1, MAX_EXTENT_colB
             ...
             !DIR$ OFFLOAD begin target(mic:target_id) if(target_id > -1)    &
                              nocopy(colA_tp)                                &
                              in( matrix_B(:,j:j) :                          &
                                  alloc_if(.true.) free_if(.false.)          &
                                  into(colB)           )                     &
       ...
       !DIR$ OFFLOAD begin target(mic)  in(matrix_C)                     &
