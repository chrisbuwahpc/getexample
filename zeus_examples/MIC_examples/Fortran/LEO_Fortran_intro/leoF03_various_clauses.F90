...
!     to this current requirement will result in a run-time failure during 
!     execution of the offload code section.  
!
!     (e.g, xxxx_vreadfrom failed 14)
!
...
!.............................................................................
    ...
    CASE(1)
       ...
       !DIR$ OMP OFFLOAD target(mic) in(array_A, var_c, DIMX, min_val)  &
                                     out(array_B)                       &
                                     inout(var_d)                       &
                                     nocopy(tmp_e)                      &
    ...
    CASE(2)
       ...
       !DIR$ OFFLOAD BEGIN target(mic) in(array_A, var_c, DIMX, min_val)  &
                                       out(array_B)                       &
                                       inout(var_d)                       &
                                       nocopy(tmp_e)                      &
                           in(offload_section_id) inout(offload_sections)
